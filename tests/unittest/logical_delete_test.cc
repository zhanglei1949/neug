...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>>
      e_props_locatedat = {
          {DataTypeId::kInt32, "since",
           execution::property_to_value(Property::from_int32(0))},
          {DataTypeId::kVarchar, "city",
           execution::property_to_value(Property::from_string_view("string"))}};
  graph_.CreateEdgeType(
