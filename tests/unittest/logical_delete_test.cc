...
TEST_F(PropertyGraphLogicalDeleteTest, DeleteVertexType_RemovesTypeAndData) {
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>> properties = {
      {DataTypeId::kInt32, "age", execution::property_to_value(Property::from_int32(0))},
      {DataTypeId::kVarchar, "name", execution::property_to_value(Property::from_string_view("string"))}};
  std::vector<std::string> pk_names = {"id"};
  properties.insert(properties.begin(),
                    {DataTypeId::kInt64, "id", execution::property_to_value(Property::from_int64(0L))});
...
TEST_F(PropertyGraphLogicalDeleteTest, DeleteEdgeTypePhysical_RemovesEdgeType) {
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>> v_props = {
      {DataTypeId::kInt64, "id", execution::property_to_value(Property::from_int64(0L))}};
  std::vector<std::string> pk_names = {"id"};
  ...
  // Create edge type
  std::vector<std::tuple<DataType, std::string, execution::Value>> e_props = {
      {DataTypeId::kInt32, "years", execution::property_to_value(Property::from_int32(0))}};
...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>> e_props = {
      {DataTypeId::kInt32, "years", execution::property_to_value(Property::from_int32(0))},
      {DataTypeId::kVarchar, "position", execution::property_to_value(Property::from_string_view("string"))}};
...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>> properties = {
      ...
      {DataTypeId::kVarchar, "name", execution::property_to_value(Property::from_string_view("string"))},
      {DataTypeId::kInt32, "age", execution::property_to_value(Property::from_int32(0))},
      {DataTypeId::kVarchar, "email", execution::property_to_value(Property::from_string_view("string"))}};
  std::vector<std::string> pk_names = {"id"};
...
TEST_F(PropertyGraphLogicalDeleteTest,
  ...
  std::vector<std::tuple<DataType, std::string, execution::Value>> e_props_workat = {
      {DataTypeId::kInt32, "years", execution::property_to_value(Property::from_int32(0))},
      {DataTypeId::kVarchar, "position", execution::property_to_value(Property::from_string_view("string"))}};
  std::vector<std::tuple<DataType, std::string, execution::Value>> e_props_locatedat = {
      {DataTypeId::kInt32, "since", execution::property_to_value(Property::from_int32(0))},
      {DataTypeId::kVarchar, "city", execution::property_to_value(Property::from_string_view("string"))}};
  graph_.CreateEdgeType(
